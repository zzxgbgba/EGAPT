...
/*********************************************AccTolerant-EGAPT*********************************************************/
        System.out.println("");
        System.out.println("Tolerant-ACC-EGAPT:");

/*读取计划信息start*/
        System.out.println("开始进行课程计划信息(包含意外,假设长时间存在)的读取");
        ArrayList<Lesson> lessonList_Acc = Tool.ReadLongData();
        System.out.println("课程计划信息(包含意外,假设长时间存在)读取完毕");
        /*读取计划信息end*/
        ...
        lessonList_Acc = Tool.ReadAccData();
        ...
        EGAPT_Acc = new GeneticAlgorithmTest(1000,50,0.8,0.01,vmIDArray,phyMachineList,timeLine, normalSchedule, eliteSchedule);

        //计算适应度
        Fitness fitnessAcc = EGAPT_Acc.getFitness(eliteSchedule_Acc);
        System.out.println("Acc-EGAPT:");
        System.out.println("适应度和:"+fitnessAcc.getFitness());
        System.out.println("负载平衡指数:"+fitnessAcc.getVload());
        System.out.println("能耗指数:"+fitnessAcc.getElecost());
